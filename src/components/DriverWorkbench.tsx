      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-300 mt-1 max-w-3xl leading-relaxed">
            Production-grade drivers bridging host AI pipelines (PyTorch, vLLM, SGLang, Triton) to the silicon photonic core via high-speed PCIe Gen 6.0 x16 / CXL 3.1 DMA rings and hardware-level non-volatile PCM weight control.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 bg-slate-950 border border-slate-800 rounded-2xl p-5 flex flex-col justify-between">
          <div>
            ...
            <div className="flex items-center justify-between pb-3 border-b border-slate-800 mb-4 overflow-x-auto">
              ...
              <div className="flex items-center gap-2 pl-2">
                <button
                  onClick={handleCopy}
                  className="px-2.5 py-1 rounded-md bg-slate-900 hover:bg-slate-800 text-slate-300 border border-slate-700 text-xs font-mono flex items-center gap-1 transition-all"
                  title="Copy code"
                >
          ...
          <div className="mt-4 pt-3 border-t border-slate-800 flex items-center justify-between text-xs font-mono text-slate-400">
            <span>Location: \`/{selectedSnippet.filename}\`</span>
          ...
          <div className="bg-slate-950 border border-slate-800 rounded-2xl p-5 font-mono shadow-2xl flex flex-col h-[400px]">
            ...
            >
              ...
              <input
                ...
                placeholder="Type 'kimi-smi', 'kimi-diag --test-optics', 'kimi-weights --status'..."
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2 text-xs font-mono">
              <button
                ...
                className="p-2 rounded-lg bg-slate-950 hover:bg-slate-800 border border-slate-800 text-left text-cyan-300 transition-all flex items-center gap-2"
              >
              ...
              <button
                ...
                className="p-2 rounded-lg bg-slate-950 hover:bg-slate-800 border border-slate-800 text-left text-emerald-300 transition-all flex items-center gap-2"
              >
              ...
              <button
                ...
                className="p-2 rounded-lg bg-slate-950 hover:bg-slate-800 border border-slate-800 text-left text-purple-300 transition-all flex items-center gap-2"
              >
              ...
              <button
                onClick={() => handleExecuteCommand('kimi-benchmark --batch 16 --seq 4096')}
                className="p-2 rounded-lg bg-slate-950 hover:bg-slate-800 border border-slate-800 text-left text-amber-300 transition-all flex items-center gap-2"
              >
                <Play className="w-3.5 h-3.5 shrink-0 text-amber-400" />
                <span className="truncate">kimi-benchmark</span>
              </button>
            </div>
          </div>
        </div>
